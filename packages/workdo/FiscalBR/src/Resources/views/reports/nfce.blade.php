...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('fiscalbr.reports.nfce') }}">
                    <div class="row">
                        <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h6 class="text-muted">{{ __('Total de Cupons') }}</h6>
                        <h3>{{ $total_notas }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h6 class="text-muted">{{ __('ICMS Total') }}</h6>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h5>{{ __('Notas Fiscais de Consumidor') }}</h5>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center">{{ __('Nenhum cupom encontrado') }}</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
