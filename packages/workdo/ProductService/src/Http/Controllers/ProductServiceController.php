...
class ProductServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->isAbleTo('product&service create')) {
            ...
            $productService->csosn          = $request->csosn;
            $productService->aliquota_icms  = $request->aliquota_icms;
            $productService->valor_icms     = $request->valor_icms;
            $productService->base_calculo_icms = $request->base_calculo_icms;
            $productService->cst_pis        = $request->cst_pis;
            $productService->aliquota_pis   = $request->aliquota_pis;
            $productService->valor_pis      = $request->valor_pis;
            $productService->cst_cofins     = $request->cst_cofins;
            $productService->aliquota_cofins = $request->aliquota_cofins;
            $productService->valor_cofins   = $request->valor_cofins;
            $productService->unidade_comercial = $request->unidade_comercial;
            $productService->codigo_ean     = $request->codigo_ean;
            $productService->cfop           = $request->cfop;
            $productService->ncm            = $request->ncm;
            $productService->cest           = $request->cest;
            $productService->cst_icms       = $request->cst_icms;
            $productService->csosn          = $request->csosn;
            $productService->aliquota_icms  = $request->aliquota_icms;
            $productService->valor_icms     = $request->valor_icms; // Este campo pode ser calculado, mas é bom ter no fillable
            $productService->base_calculo_icms = $request->base_calculo_icms; // Este campo pode ser calculado, mas é bom ter no fillable
            $productService->cst_pis        = $request->cst_pis;
            $productService->aliquota_pis   = $request->aliquota_pis;
            $productService->valor_pis      = $request->valor_pis; // Este campo pode ser calculado, mas é bom ter no fillable
            $productService->cst_cofins     = $request->cst_cofins;
            $productService->aliquota_cofins = $request->aliquota_cofins;
            $productService->valor_cofins   = $request->valor_cofins; // Este campo pode ser calculado, mas é bom ter no fillable
            $productService->unidade_comercial = $request->unidade_comercial;
            $productService->codigo_ean     = $request->codigo_ean;
