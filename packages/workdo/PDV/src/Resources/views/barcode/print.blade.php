...
@section('page-title')
    {{__('Manage PDV Barcode Print')}}
@endsection
@section('page-breadcrumb')
    {{__('Product Barcode')}},
    {{__('PDV Barcode Print')}}
@endsection
...
@section('page-action')
    <div class="float-end">
        <a href="{{ route('pdv.barcode') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{__('Back')}}">
...
@section('content')
    <div class="row mt-3">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{Form::open(array('route'=>'pdv.receipt','method'=>'post','class'=>'needs-validation','novalidate'))}}
