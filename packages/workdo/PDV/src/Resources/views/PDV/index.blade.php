...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('packages/workdo/PDV/src/Resources/assets/css/site.css') }}" id="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('packages/workdo/PDV/src/Resources/assets/css/custom.css') }}" id="main-style-link">
    <style>
...
<body class="{{ isset($themeColor) ? $themeColor : 'theme-1' }}">
    ...
    <div class="container-fluid px-2">
        ...
        <div class="row">
            <div class="col-12">
                <div class="mt-2 pdv-top-bar bg-color d-flex align-items-center justify-content-between bg-primary gap-2">
                                                ...
                                                <tr data-product-id="{{ $id }}" id="product-id-{{ $id }}">
                                                    ...
                                                    <td>
                                                        @if (!empty($product->tax_id))
                                                            @php
                                                                $taxes = \workdo\PDV\Entities\PDV::tax($product->tax_id);
                                                            @endphp
                                                    ...
                                                    <td class="col-sm-2 mt-2">
                                                        <a href="#"
                                                            class="action-btn  show_confirm-pdv"
                                ...
                                <div class="d-flex align-items-center justify-content-between pt-3 gap-2" id="btn-pur">
                                    @if (module_is_active('ProductService'))
                                        <button type="button" class="btn btn-primary pay-btn m-0" data-ajax-popup="true"
                                            ...
                                            data-url="{{ route('pdv.create') }}"
                                            data-title="{{ __('PDV Invoice') }}"
                                    ...
                                    @else
                                        <button type="button" class="btn btn-primary" data-ajax-popup="true"
                                            data-size="lg" data-align="centered"
                                            data-url="{{ route('pdv.create') }}"
                                            data-title="{{ __('PDV Invoice') }}" disabled="disabled">
                                            {{ __('PAY') }}
                                        </button>
                                    @endif
                                    <div class="tab-content btn-empty text-end">
                                        <a href="#" class="btn btn-danger show_confirm-pdv m-0"
    ...
    <div class="pdvition-fixed top-0 end-0 p-3" style="z-index: 99999">
    ...
    <script src="{{ asset('packages/workdo/PDV/src/Resources/assets/js/moment.min.js') }}"></script>
    ...
    <script src="{{ asset('packages/workdo/PDV/src/Resources/assets/js/jscolor.js') }}"></script>
    <script src="{{ asset('packages/workdo/PDV/src/Resources/assets/js/custom.js') }}"></script>
...
@endif
    ...
    <script>
        var site_currency_symbol_pdvition = "{{isset($company_settings['site_currency_symbol_pdvition']) ? $company_settings['site_currency_symbol_pdvition'] : 'pre'}}";
