    ...
    <div class="container">
        <div class="row align-items-center mb-4 invoice mt-2">
            <div class="col invoice-details">
                <h1 class="invoice-id h6">{{ $details['pdv_id'] }}</h1>
        ...
        <div class="col-12 col-md-12">
            ...
            @if ($details['pay'] == 'show')
                    ...
                    data-url="{{ route('pdv.printview') }}" data-ajax-popup="true" data-size="sm"
                    data-bs-toggle="tooltip" data-title="{{ __('PDV Invoice') }}">
                    {{ __('Cash Payment') }}
                </button>
            @endif
        </div>
