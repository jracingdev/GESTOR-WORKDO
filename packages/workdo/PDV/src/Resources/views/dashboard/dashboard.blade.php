            ...
            <div class="dashboard-card">
                ...
                <div class="card-inner">
                    <div class="card-content">
                        ...
                        <p>{{__('Streamline sales and inventory with our all-in-one PDV solution for enhanced business efficiency')}}</p>
                    </div>
...
@push('scripts')
    <script src="{{ asset('packages/workdo/PDV/src/Resources/assets/js/apexcharts.min.js') }}"></script>
