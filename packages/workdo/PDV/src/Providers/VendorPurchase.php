...
namespace Workdo\PDV\Providers;
                ...
                try {
                    ...
                    if(!empty($ids))
                    {
                        ...
                        try {
                            ...
                            {
                                $view->getFactory()->startPush('vendor_purchase_tab', view('pdv::vendor-purchase.sidebar'));
                                $view->getFactory()->startPush('vendor_purchase_div', view('pdv::vendor-purchase.nav_containt_div',compact('vendor')));
                            }
                        } catch (\Throwable $th)
                        {
