...
class ReportController extends Controller
{
    ...
    public function posDailyReport(Request $request)
    {
        ...
        if(\Auth::user()->isAbleTo('report pos'))
        {
            ...
            return view('pdv::report.daily_pos',compact('warehouse','customer','arrDuration','data','filter'));
        }
        else
        {
    ...
    public function posMonthlyReport(Request $request)
    {
        if(\Auth::user()->isAbleTo('report pos'))
        {
            ...
            return view('pdv::report.monthly_pos',compact('monthList','yearList','warehouse','customer','arrDuration','data','filter'));
    ...
    public function posVsPurchaseReport(Request $request)
    {
        if(\Auth::user()->isAbleTo('report pos'))
        {
            ...
            return view('pdv::report.pos_vs_purchase', compact('filter'),  $data);
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
