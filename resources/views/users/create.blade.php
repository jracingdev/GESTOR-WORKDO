...
{{Form::open(array('url'=>'users','method'=>'post','class'=>'needs-validation','novalidate','enctype'=>'multipart/form-data'))}}
    ...
    <div class="row">
        ...
        @if(Auth::user()->type == 'super admin')
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    {{Form::text('endereco_completo',null,array('class'=>'form-control','placeholder'=>__('Street, Number, Neighborhood'),'id'=>'endereco_completo'))}}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    {{Form::label('cidade',__('City'),['class'=>'form-label'])}}
                    {{Form::text('cidade',null,array('class'=>'form-control','placeholder'=>__('Enter City'),'id'=>'cidade'))}}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div id="map_container" style="height: 300px; border: 1px solid #ddd; border-radius: 5px; display: none;">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{Form::text('celular',null,array('class'=>'form-control','placeholder'=>__('(00) 00000-0000'),'id'=>'celular_input'))}}
            </div>
        </div>
        <x-mobile ></x-mobile>
            ...
            if (cnpj.length === 14) {
                ...
                fetch(`https://brasilapi.com.br/api/cnpj/v1/${cnpj}`)
                    ...
                    .then(data => {
                        ...
                        document.querySelector('input[name="name"]').value = data.razao_social || data.nome_fantasia || '';
